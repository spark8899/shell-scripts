#!/bin/sh
#Usage: install reality.
#Created by spark8899 2023-05-04
#Last Modified:
...
shortIds: 88
====================================
vless://${v2uuid}@$(getIP):443?encryption=none&flow=xtls-rprx-vision&security=reality&sni=www.amazon.com&fp=chrome&pbk=${rePublicKey}&sid=88&type=tcp&headerType=none#createWall-reality
...
client_re(){
    ...
    echo "shortIds: 88"
    echo "===================================="
    echo "vless://${v2uuid}@$(getIP):443?encryption=none&flow=xtls-rprx-vision&security=reality&sni=www.amazon.com&fp=chrome&pbk=${rePublicKey}&sid=88&type=tcp&headerType=none#createWall-reality"
    echo
}
